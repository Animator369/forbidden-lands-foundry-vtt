...
(() => {
    ...
    var define_GLOBALPATHS_default, init_define_GLOBALPATHS = __esm({
        "<define:GLOBALPATHS>"() {
            define_GLOBALPATHS_default = ["systems/forbidden-lands/templates/components/item-chatcard.hbs", "systems/forbidden-lands/templates/components/modifiers-component.hbs", "systems/forbidden-lands/templates/components/sheet-config-modal.hbs", "systems/forbidden-lands/templates/components/sheet-config.hbs", "systems/forbidden-lands/templates/components/tables-config.hbs", "systems/forbidden-lands/templates/components/character-generator/generator-sheet.hbs", "systems/forbidden-lands/templates/components/character-generator/list-component.hbs", "systems/forbidden-lands/templates/components/roll-engine/dialog.hbs", "systems/forbidden-lands/templates/components/roll-engine/infos.hbs", "systems/forbidden-lands/templates/components/roll-engine/roll.hbs", "systems/forbidden-lands/templates/components/roll-engine/spell-dialog.hbs", "systems/forbidden-lands/templates/components/roll-engine/tooltip.hbs", "systems/forbidden-lands/templates/actor/_shared-template-tabs/gear-tab.hbs", "systems/forbidden-lands/templates/actor/monster/monster-sheet.hbs", "systems/forbidden-lands/templates/actor/character/character-limited-sheet.hbs", "systems/forbidden-lands/templates/actor/character/character-sheet.hbs", "systems/forbidden-lands/templates/actor/character/npc-sheet.hbs", "systems/forbidden-lands/templates/actor/party/party-sheet.hbs", "systems/forbidden-lands/templates/system/combat/combat.hbs", "systems/forbidden-lands/templates/item/armor/armor-sheet.hbs", "systems/forbidden-lands/templates/item/armor/main-tab.hbs", "systems/forbidden-lands/templates/item/building/building-sheet.hbs", "systems/forbidden-lands/templates/actor/stronghold/stronghold-sheet.hbs", "systems/forbidden-lands/templates/item/critical-injury/critical-injury-sheet.hbs", "systems/forbidden-lands/templates/item/gear/gear-sheet.hbs", "systems/forbidden-lands/templates/item/gear/main-tab.hbs", "systems/forbidden-lands/templates/item/monster-attack/monster-attack-sheet.hbs", "systems/forbidden-lands/templates/item/hireling/hireling-sheet.hbs", "systems/forbidden-lands/templates/item/raw-material/raw-material-sheet.hbs", "systems/forbidden-lands/templates/item/spell/spell-sheet.hbs", "systems/forbidden-lands/templates/item/talent/talent-sheet.hbs", "systems/forbidden-lands/templates/item/weapon/main-tab.hbs", "systems/forbidden-lands/templates/item/weapon/weapon-sheet.hbs", "systems/forbidden-lands/templates/actor/monster/sheet-tabs/combat-tab.hbs", "systems/forbidden-lands/templates/actor/character/sheet-tabs/bio-tab.hbs", "systems/forbidden-lands/templates/actor/character/sheet-tabs/combat-tab.hbs", "systems/forbidden-lands/templates/actor/character/sheet-tabs/main-tab.hbs", "systems/forbidden-lands/templates/actor/character/sheet-tabs/talent-tab.hbs", "systems/forbidden-lands/templates/item/_shared-template-tabs/artifact-tab.hbs", "systems/forbidden-lands/templates/item/_shared-template-tabs/supply-tab.hbs", "systems/forbidden-lands/templates/actor/party/components/action-component.hbs", "systems/forbidden-lands/templates/actor/party/components/character-picker-dialog.hbs", "systems/forbidden-lands/templates/actor/party/components/member-component.hbs", "systems/forbidden-lands/templates/actor/party/sheet-tabs/main-tab.hbs", "systems/forbidden-lands/templates/actor/party/sheet-tabs/travel-tab.hbs", "systems/forbidden-lands/templates/actor/stronghold/sheet-tabs/building-tab.hbs", "systems/forbidden-lands/templates/actor/stronghold/sheet-tabs/gear-tab.hbs", "systems/forbidden-lands/templates/actor/stronghold/sheet-tabs/hireling-tab.hbs"]
        }
    });
    ...
    var ForbiddenLandsActor = class extends Actor {
        ...
        async createEmbeddedDocuments(embeddedName, data, options) {
            ...
            for await (let entity of newData) if (entity.system) {
                for await (let [key, value] of Object.entries(entity.system)) if (typeof value == "string" && value.match(inlineRoll)) {
        ...
        static async create(data, options) {
            ...
            return data.type === "character" && !game.user?.isGM && (data.prototypeToken ??= {}, data.prototypeToken.actorLink = !0, data.prototypeToken.disposition = 1), super.create(data, options)
        }
        toggleCondition(conditionName) {
            ...
            currentEffect ? (this.system.condition[conditionName].value && this.update({
                [`system.condition.${conditionName}.value`]: !1
            }), this.deleteEmbeddedDocuments("ActiveEffect", [currentEffect.id])) : this.createEmbeddedDocuments("ActiveEffect", [{
        ...
        rest() {
            let activeConditions = Object.entries(this.conditions ?? {}).filter(([_2, value]) => value?.value),
                isBlocked = (...conditions) => conditions.some(condition => activeConditions.map(([key, _2]) => key).includes(condition)),
                data = {
                    attribute: {
                        agility: {
                        ...
                        strength: {
                            value: isBlocked("thirsty", "cold", "hungry") ? this.attributes.strength.value : this.attributes.strength.max
                        },
                        wits: {
                            value: isBlocked("thirsty", "cold", "sleepy") ? this.attributes.wits.value : this.attributes.wits.max
                        },
                        empathy: {
            ...
            let formatter = new Intl.ListFormat(game.i18n.lang, {
                style: "long"
            });
            ChatMessage.create({
                content: `<div class="forbidden-lands chat-item"><h3>${this.name}</h3><h4>${localizeString("ACTION.REST")}</h4>${wasSleepy?`<p>${this.name} ${localizeString("CONDITION.IS_NO_LONGER_SLEEPY")}.</p>`:""}${activeConditions.length?`<p>${this.name} ${localizeString("CONDITION.SUFFERING_FROM")} ${formatter.format(activeConditions.filter(([key,_2])=>key!=="sleepy").map(([_2,value])=>`<b>${localizeString(value.label)}</b>`))}.</p>`:""}</div>`,
                speaker: {
                    actor: this
                },
    ...
    async function importMacros() {
        ...
        let pack = await foundry.documents.collections.CompendiumCollection.createCompendium({
    ...
    function coerceNum(string) {
        ...
        let array = Array.from(string.split(".", 3), v => Number.parseInt(v));
        if (array.some(v => Number.isNaN(v)) || array.length !== 3) throw new Error(`Invalid SemVer string: ${string}`);
    ...
    var ForbiddenLandsD6 = class extends foundry.dice.terms.Die {
    ...
    var YZUR = {
        ...
        YearZeroRoll = class _YearZeroRoll extends Roll {
            ...
            removeDice(qty, search, {
                ...
                return terms[0] instanceof OperatorTerm && terms.shift(), this._formula = this.constructor.getFormula(this.terms), this._evaluated && (this.terms.length ? this._total = this._evaluateTotal() : this._total = 0), this
            }
            async push({
                async
            } = {}) {
        ...
        YearZeroRollManager = class _YearZeroRollManager {
            ...
            static createDieClass(data) {
                ...
                if (lockedValues != null) {
                    ...
                    for (let [i, v] of lockedValues.entries())
                        if (typeof v != "number") throw new DieTermError(`YZUR | Invalid die class locked value "${v}" at [${i}] (Not a Number)`);
    ...
    var FBLRollHandler = class _FBLRollHandler extends FormApplication {
        ...
        constructor({
            ...
            super({}, options), this.base = attribute, this.skill = skill, this.gear = gear, this.damage = options.damage || gear.damage, this.damageType = options.damageType || gear.damageType || "non-typical", this.artifact = gear?.artifactDie, this.gears = options.gears || [], this.modifier = options.modifiers?.reduce((sum, mod) => mod.active ? sum + Number(mod.value) : sum, 0) || 0, this.spell = {
                safecast: 0,
                ...spell
            }
        }
        ...
        _validateForm(event, formData) {
            let isEmpty = Object.entries(formData).filter(([key]) => key !== "damageType").map(([_2, value]) => value).every(value => !value),
        ...
        async _handleRollSpell({
            ...
            let actor = _FBLRollHandler.resolveActor({
        ...
        async _handleYZRoll({
            ...
            if (this.damageType = damageType || this.damageType, Object.values(modifierItems).some(item => item)) {
        ...
        getRollOptions() {
            let target = Array.from(game.user?.targets || [])[0] || null,
                attackCategory = this.gear?.category || null,
                attackAmmo = this.gear?.ammo || null,
                unlimitedPush = this.options.unlimitedPush,
                isMonster = game.actors.get(this.options.actorId)?.system.type === "monster",
                maxPush = unlimitedPush ? 1e4 : isMonster ? 0 : 1;
            return {
                name: this.title,
                title: this.title,
                ...
                targetSceneId: target?.scene?.id || target?.document?.parent?.id || canvas.scene?.id || null,
        ...
        async handleRollArrows() {
            if (!(this.options.actorType === "character")) return;
            let gearCategory = String(this.gear?.category || "").toLowerCase().trim(),
                gearAmmo = String(this.gear?.ammo || "").toLowerCase().trim(),
                isRangedByGear = gearCategory.includes("ranged"),
                hasArrowsByGear = gearAmmo === "arrows",
                isRangedByItem = !1,
                hasArrowsByItem = !1,
                actor = this.constructor.getSpeaker({
                    actor: this.options.actorId,
                    scene: this.options.sceneId,
                    token: this.options.tokenId
                });
            if (actor) {
                let itemId = Array.isArray(this.options.itemId) ? this.options.itemId[0] : this.options.itemId,
                    item = itemId ? actor.items.get(itemId) : null,
                    itemCategory = String(item?.system?.category || "").toLowerCase().trim(),
                    itemAmmo = String(item?.system?.ammo || "").toLowerCase().trim();
                isRangedByItem = itemCategory.includes("ranged"), hasArrowsByItem = itemAmmo === "arrows"
            }
            if ((isRangedByGear && hasArrowsByGear || this.options.isAttack && isRangedByItem && hasArrowsByItem) && actor?.sheet?.rollConsumable) try {
        ...
        static async pushRoll(msg) {
            ...
            await roll.push();
            let actor = msg.actor ?? this.resolveActor(msg.speaker);
            return actor && await this.updateActor(roll, actor), roll.toMessage()
        }
        static resolveActor(speakerData) {
            return speakerData instanceof foundry.documents.BaseActor ? speakerData : speakerData?.token && speakerData?.scene ? game.scenes.get(speakerData.scene)?.tokens.get(speakerData.token)?.actor ?? null : speakerData?.actor ? game.actors.get(speakerData.actor) : null
        }
        ...
        static async applyAttributDamage({
            ...
            let actor = this.resolveActor(speakerData);
            if (!actor) return;
            let appliedDamage = characterDamage.attribute,
                currentDamage = attributeTrauma - appliedDamage;
            await this.modifyWillpower(actor, currentDamage);
            let value = actor.system.attribute?.[attribute]?.value ?? 0;
            value = Math.max(value - currentDamage, 0), value === 0 && ui.notifications.notify(game.i18n.localize("NOTIFY.YOU_ARE_BROKEN")), await actor.update({
        ...
        static async applyGearDamage({
            ...
            let actor = this.resolveActor(speakerData);
            if (!actor) return;
            let gear = actor.items.contents.sort((_2, b3) => b3.system?.state === "equipped" ? 1 : -1),
                items = Object.keys(gearDamageByName).map(itemName => gear.find(g2 => g2.name === itemName)).filter(Boolean);
            if (!items.length) return;
            let updatedItems = items.map(item => {
                let currentBonus = item.system?.bonus?.value ?? 0,
                    damage = gearDamageByName[item.name],
                    newValue = Math.max(currentBonus - damage, 0);
                return newValue === 0 && ui.notifications.notify(game.i18n.localize("NOTIFY.YOUR_ITEM_BROKE")), {
                    _id: item.id,
        ...
        static async modifyWillpower(speakerData, value, operation = "add") {
            let actor = this.resolveActor(speakerData);
            if (!actor) return;
            let current = actor.system?.bio?.willpower?.value ?? 0,
                max = actor.system?.bio?.willpower?.max ?? 0,
                newValue = operation === "add" ? Math.min(current + value, max) : Math.max(current - value, 0);
            return await actor.update({
                "system.bio.willpower.value": newValue
            })
        }
        static async decreaseConsumable(messageId) {
            ...
            let {
                speaker,
                rolls
            } = msg, consumable = rolls?.[0]?.options?.consumable;
            if (!consumable) return;
            let actor = this.resolveActor(speaker);
            if (!actor) return;
            ui.notifications.info(game.i18n.localize("NOTIFY.CONSUMABLE_USED"));
            let currentValue = actor.system?.consumable?.[consumable]?.value ?? 0,
    ...
    var FBLRoll = class extends YearZeroRoll {
        ...
        get attackSuccess() {
            ...
            let defenseSuccess = Number(this.options?.defenseSuccess || 0),
                armorSuccess = Number(this.options?.armorSuccess || 0),
                resistSuccess = Number(this.options?.resistSuccess || 0);
            return Math.max(this.successCount - defenseSuccess - armorSuccess - resistSuccess, 0)
        }
        get damage() {
            if (this.options?.isMonsterAttack && this.options?.attack?.system?.damageType === "fear") return this.attackSuccess;
            let modifier = this.type === "spell" ? 0 : -1;
            return (this.options.damage || 0) + Math.max(this.attackSuccess + modifier, 0)
        }
    ...
    var ForbiddenLandsItem = class extends Item {
        ...
        async sendToChat() {
            ...
            let html = await foundry.applications.handlebars.renderTemplate("systems/forbidden-lands/templates/components/item-chatcard.hbs", itemData),
                chatData = {
                    user: game.userId,
    ...
    var ALL_TABLES = {},
        getTables = async (path, fileName) => (fileName = fileName.replace("_rooms", ""), await fetch(`modules/${path}/manifests/${fileName}.json`).then(res => res.json()).catch(err => {
            ...
            let titleCase = string => {
                    let i18nKey = `ADVENTURE_SITE.TYPE.${string.toUpperCase()}`,
                        translated = localizeString(i18nKey);
                    return translated !== i18nKey ? translated : string.replace(/_/g, " ").replace(/\b\w/g, char => char.toUpperCase())
                },
            ...
            let [path, adventureSite] = type.split(":"), content = await CONFIG.fbl.adventureSites.generate(path, adventureSite), title = titleCase(adventureSite);
            (await JournalEntry.create({
                name: `${localizeString("ADVENTURE_SITE.LABEL")}: ${title}`,
                pages: [{
                    name: title,
                    text: {
            ...
            let html = await foundry.applications.handlebars.renderTemplate(`modules/${path}/templates/${adventureSite}.hbs`, data);
    ...
    var FBL = {
            ...
            weaponFeatures: ["blunt", "edged", "hook", "parrying", "shield", "pointed", "ready", "slowReload"]
        },
        modifyConfig = () => {
    ...
    function registerHandlebarsHelpers() {
        Handlebars.registerHelper("skulls", function(current, max, block) {
            ...
            let meleeFeatures = ["edged", "pointed", "blunt", "parry", "hook"],
                rangedFeatures = ["edged", "pointed", "blunt", "ready", "slowReload"];
    ...
    function P(e) {
        ...
        function h() {
            a = t.substring(g2, o.lastIndex - n[0].length), a && r.children.push({
                type: 2,
                value: a,
                parent: r
            })
        ...
        return a = t.slice(g2), r.children.push({
            type: 2,
            value: a,
            parent: r
        }), i
    ...
    var O = class {
            ...
            visit(t, i, r) {
                if (this.callback(t, i, r), Array.isArray(t.children))
    ...
    function E(e, t = [p]) {
        ...
        for (let r of t) Object.defineProperty(i, r, {
            value: !0,
            enumerable: !1,
            writable: !1
        });
    ...
    function y(e) {
        return e.replace(/[&<>]/g, t => A[t] || t)
    }

    function N(e) {
        let t = "";
        for (let [i, r] of Object.entries(e)) t += ` ${i}="${r}"`;
        return E(t, [p, M])
    }
    ...
    async function k(e) {
        let {
            name: t,
            attributes: i = {}
        } = e, r = await Promise.all(e.children.map(a => _(a))).then(a => a.join(""));
        if (f in e) {
            let a = await e[f](i, E(r));
            return a && a[p] ? a.value : y(String(a))
        }
        if (t === S) return r;
        let n = C(e);
        return n || D.has(t) ? `<${e.name}${N(i).value}${n?" /":""}>` : `<${e.name}${N(i).value}>${r}</${e.name}>`
    }
    async function _(e) {
        switch (e.type) {
            case 0:
                return Promise.all(e.children.map(t => _(t))).then(t => t.join(""));
            case 1:
                return k(e);
            case 2:
                return `${e.value}`;
    ...
    function f2(t) {
        ...
        };
        {
            ...
            for (let l of t.dropElements ?? []) e.add(l);
            return {
                allowComponents: !1,
                allowCustomElements: !1,
                allowComments: !1,
    ...
    function w2(t, n, e) {
        var l, o2, s, r;
        return ((l = e.allowElements) == null ? void 0 : l.length) > 0 && e.allowElements.includes(t) ? "allow" : ((o2 = e.blockElements) == null ? void 0 : o2.length) > 0 && e.blockElements.includes(t) ? "block" : ((s = e.dropElements) == null ? void 0 : s.length) > 0 && e.dropElements.find(u => u === t) || n === "component" && !e.allowComponents || n === "custom-element" && !e.allowCustomElements ? "drop" : e.unblockElements ? e.unblockElements.some(u => u === t) ? "allow" : "block" : ((r = e.allowElements) == null ? void 0 : r.length) > 0 ? "drop" : "allow"
    }

    function b2(t, n) {
        var l, o2, s, r, u, m, c, d;
        let e = t.attributes;
        for (let i of Object.keys(t.attributes))(l = n.allowAttributes) != null && l[i] && (o2 = n.allowAttributes) != null && o2[i].includes(t.name) || (r = (s = n.allowAttributes) == null ? void 0 : s[i]) != null && r.includes("*") || ((u = n.dropAttributes) != null && u[i] && (m = n.dropAttributes) != null && m[i].includes(t.name) || (d = (c = n.dropAttributes) == null ? void 0 : c[i]) != null && d.includes("*")) && delete e[i];
        return e
    }
    ...
    function N2(t) {
        ...
        return e => {
            ...
            for (let o2 = l.length - 1; o2 >= 0; o2--) l[o2]();
            return e
        }
    }
    ...
    var FLAG_SCOPE = "forbidden-lands";
    ...
    function applyAttackStateToRoll(message, roll) {
        let state = getAttackState(message);
        return foundry.utils.mergeObject(roll.options, state, {
            inplace: !0
        })
    }
    async function saveAttackState(message, roll) {
        let state = getAttackStatePayload(roll);
    ...
    function getAttackStatePayload(roll) {
        return {
            ...
            resistUsed: !!roll.options.resistUsed,
            resistSuccess: Number(roll.options.resistSuccess || 0),
    ...
    function isActiveGM() {
        ...
        return game.user?.isGM ? !activeGM || activeGM.id === game.user.id : !1
    }
    ...
    async function persistAttackMessageState(message, roll) {
        let state = getAttackStatePayload(roll);
        if (message.isOwner) {
            await saveAttackState(message, roll), await refreshAttackMessage(message, roll);
            return
        }
    ...
    function getTargetFromRollOptions(roll) {
        let tokenId = roll?.options?.targetTokenId;
        if (!tokenId) return null;
        let sceneId = roll?.options?.targetSceneId,
            sceneToken = (sceneId ? game.scenes.get(sceneId) : null)?.tokens?.get(tokenId)?.object;
        return sceneToken || canvas.tokens?.get(tokenId) || null
    }

    function getAttackTarget(message, roll = message.rolls?.[0]) {
        let optionTarget = getTargetFromRollOptions(roll);
        if (optionTarget?.actor) return optionTarget.actor;
        let author = message.author || game.users.get(message._source?.author) || game.users.get(message.user?.id) || game.users.get(message.user);
        if (!author) return null;
        let targetRef = Array.from(author.targets || [])[0] || null;
        return targetRef && (typeof targetRef == "string" ? canvas.tokens?.get(targetRef) : targetRef)?.actor || null
    }

    function canCurrentUserUseAttackActions(message, roll) {
        return !!getAttackTarget(message, roll)?.isOwner
    }

    function getAttackItem(roll) {
        let attacker = game.actors.get(roll.options.actorId);
        if (!attacker) return null;
        let itemId = Array.isArray(roll.options.itemId) ? roll.options.itemId[0] : roll.options.itemId;
        return itemId && attacker.items.get(itemId) || null
    }

    function isRangedAttack(roll) {
        if (String(roll?.options?.attackCategory || "").toLowerCase().trim().includes("ranged")) return !0;
        let item = getAttackItem(roll),
            itemCategory = String(item?.system?.category || "").toLowerCase().trim();
        return item?.type === "weapon" && itemCategory.includes("ranged")
    }

    function hasEquippedShield(actor) {
        return actor.items.some(item => item.state !== "equipped" ? !1 : item.type === "armor" && item.system?.part === "shield" ? !0 : !!item.system?.features?.shield)
    }

    function getParryItem(actor) {
        return actor.items.find(item => item.state === "equipped" && item.type === "weapon" && item.system?.category === "melee" && item.system?.features?.parrying) || null
    }
    async function postRollWarning(localizationKey) {
        return ChatMessage.create({
            content: `<div class="forbidden-lands chat-item"><p>${game.i18n.localize(localizationKey)}</p></div>`
        })
    }

    function getDamageAttribute(actor, damageType = "non-typical") {
        let type = String(damageType || "").toLowerCase();
        return type === "empathy" ? "empathy" : type === "wits" || type === "fear" ? "wits" : type === "endurance" ? "agility" : "strength"
    }

    function getCriticalInjuryTableByDamageType(damageType = "blunt") {
        let type = String(damageType || "").toLowerCase();
        return type === "stab" || type === "stabbing" ? "Critical Injuries - Stab Wounds" : type === "slash" || type === "slashing" ? "Critical Injuries - Slash Wounds" : type === "blunt" ? "Critical Injuries - Blunt Wounds" : null
    }
    async function tryRunRollOnTable(tableName) {
        try {
            if (typeof globalThis.rollOnTable == "function") return await globalThis.rollOnTable(tableName), !0
        } catch {}
        let macro = game.macros?.getName("rollOnTable");
        if (macro) try {
            return await macro.execute(tableName), !0
        } catch {
            try {
    ...
    async function tryTriggerTraumaTable(actor, attribute, damageType) {
        if (Number(actor.system?.attribute?.[attribute]?.value ?? 0) > 0) return;
        if (attribute === "wits") {
            await tryRunRollOnTable("Horror Trauma");
            return
        }
        if (attribute !== "strength") return;
        let tableName = getCriticalInjuryTableByDamageType(damageType);
        tableName && await tryRunRollOnTable(tableName)
    }

    function getDefenseSourceRoll(roll) {
        return roll.options?.linkedDefenseType === "armor" ? {
            success: Number(roll.successCount || 0),
            failure: Number(roll.gearDamage || roll.baneCount || 0)
        } :	roll.options?.linkedDefenseType === "resist" ? {
            success: Number(roll.successCount || 0),
            failure: 0
        } : roll.options?.linkedDefenseType === "dodge" ? {
            success: Number(roll.successCount || 0),
            failure: 0
        } : roll.options?.linkedDefenseType === "parry" ? {
            success: Number(roll.successCount || 0),
            failure: 0
        } : null
    }
    async function syncLinkedAttackFromDefenseRoll(defenseRoll) {
        let linkedAttackMessageId = defenseRoll.options?.linkedAttackMessageId;
        if (!linkedAttackMessageId) return;
        let attackMessage = game.messages.get(linkedAttackMessageId);
        if (!attackMessage) return;
        let attackRoll = attackMessage.rolls?.[0];
        if (!attackRoll?.options?.isAttack) return;
        applyAttackStateToRoll(attackMessage, attackRoll);
        let source = getDefenseSourceRoll(defenseRoll);
        if (source) {
            switch (defenseRoll.options.linkedDefenseType) {
                case "armor":
                    attackRoll.options.armorUsed = !0, attackRoll.options.armorSuccess = source.success, attackRoll.options.armorFailure = source.failure;
                    break;
					
                case "resist":
                    attackRoll.options.resistUsed = !0, attackRoll.options.resistSuccess = source.success;
                    break;
					
                case "dodge":
                case "parry":
                    attackRoll.options.defenseUsed = !0, attackRoll.options.defenseType = defenseRoll.options.linkedDefenseType, attackRoll.options.defenseSuccess = source.success;
                    break
            }
    ...
    async function applyAttackArmorDamage(targetActor, roll) {
        ...
        let armorFailure = Number(roll.options?.armorFailure || 0);
        armorFailure && (roll.attackSuccess <= 0 || await applyArmorFailureDamage(targetActor, armorFailure))
    }
    async function applyDamageToTarget(actor, roll) {
        if (Number(roll.attackSuccess || 0) <= 0) return;
        let damage = Number(roll.damage || 0),
            attribute = getDamageAttribute(actor, roll.options.gear.damageType);
        if (!damage) return;
        let currentValue = Number(actor.system?.attribute?.[attribute]?.value ?? 0),
            newValue = Math.max(currentValue - damage, 0);
        await actor.update({
            [`system.attribute.${attribute}.value`]: newValue
        }), currentValue > 0 && newValue <= 0 && await tryTriggerTraumaTable(actor, attribute, roll.options.gear.damageType)
    }
    async function rollTargetDefense(actor, type, attackMessageId, itemId = null) {
        let result = await actor.sheet.rollAction(type, itemId);
        return result?.roll && (result.roll.options.linkedAttackMessageId = attackMessageId, result.roll.options.linkedDefenseType = type, await result.message?.update({
            content: await result.roll.render()
        })), result
    }
	
    async function rollTargetResist(actor, attackMessageId) {
        let result = await actor.sheet.rollSkill("insight");
		console.log (result)
        return result?.roll && (result.roll.options.linkedAttackMessageId = attackMessageId, result.roll.options.linkedDefenseType = "resist", await result.message?.update({
            content: await result.roll.render()
        })), result
    }
    ...
    async function rollTargetArmor(actor, attackMessageId) {
        if (actor.type !== "monster") {
            let result = await actor.sheet.rollArmor();
            return result?.roll && (result.roll.options.linkedAttackMessageId = attackMessageId, result.roll.options.linkedDefenseType = "armor", await result.message?.update({
                content: await result.roll.render()
            })), result
        }
        let armor = Number(actor.system?.armor?.value || 0),
            rollName = `${game.i18n.localize("ITEM.TypeArmor")}: ${actor.name}`,
            options = {
                name: rollName,
                maxPush: "0",
                ...actor.getRollContext()
            },
            roll = FBLRoll.create(`${armor}dg[${rollName}]`, {}, options);
        await roll.roll();
        let message = await roll.toMessage();
        return roll.options.linkedAttackMessageId = attackMessageId, roll.options.linkedDefenseType = "armor", await message.update({
    ...
    function getAuthorSelectedTargetToken(message) {
        ...
        if (!author) return null;
        let targetRef = Array.from(author.targets || [])[0] || null;
        return targetRef ? typeof targetRef == "string" ? canvas.tokens?.get(targetRef) : targetRef : null
    }
    async function ensureAttackTargetOnRoll(message, roll) {
        if (roll.options?.targetTokenId) return;
        let targetToken = getAuthorSelectedTargetToken(message);
        targetToken && (roll.options.targetTokenId = targetToken.id, roll.options.targetSceneId = targetToken.scene?.id || canvas.scene?.id || null, await persistAttackMessageState(message, roll))
    }
    async function applyArmorFailureDamage(actor, amount) {
        ...
        let priorities = {
            ...
            armorItems = actor.itemTypes.armor.filter(item => {
                let part = item.system?.part;
                return item.state === "equipped" && (part === "body" || part === "head") && (item.system?.bonus?.value ?? 0) > 0
            }).sort((a, b3) => priorities[a.system.part] - priorities[b3.system.part]),
            updates = [];
        for (let item of armorItems) {
            if (remaining <= 0) break;
            let value = Number(item.system?.bonus?.value || 0),
                loss = Math.min(remaining, value);
            remaining -= loss, updates.push({
                _id: item.id,
                "system.bonus.value": value - loss
            })
        }
        updates.length && await actor.updateEmbeddedDocuments("Item", updates)
    }

    function registerHooks() {
        if (game.socket.on("system.forbidden-lands", async data => {
                if (data.operation === "pushRoll" && data.isOwner && game.messages.get(data.id)?.delete(), data.operation === "updateAttackState") {
                    if (!isActiveGM()) return;
                    let message = game.messages.get(data.id),
                        roll = message?.rolls?.[0];
                    if (!message || !roll?.options?.isAttack) return;
                    applyAttackStateToRoll(message, roll), foundry.utils.mergeObject(roll.options, data.state || {}, {
                        inplace: !0
                    }), await saveAttackState(message, roll), await refreshAttackMessage(message, roll)
                }
            ...
            }), Hooks.on("renderGamePause", (_2, html, options) => {
                let imgElement = html.querySelector("img"),
                    caption = html.querySelector("figcaption");
                html.style.height = "230px", html.style.top = `calc(50vh - ${100+.5*150}px)`, html.style.background = "none", imgElement.src = "systems/forbidden-lands/assets/fbl-sun.webp", imgElement.style.opacity = .8, imgElement.style.width = "150px", imgElement.style.height = "150px", imgElement.style.cssText += "--fa-animation-duration: 5s", caption.innerText = "Game Paused", caption.style.color = "#EEEEEE", caption.style["text-transform"] = "uppercase", caption.style["font-size"] = "1.75em", caption.style["text-shadow"] = "0px 0px 20px #000000"
        ...
        Hooks.on("renderItemSheet", app => {
            ...
            let attackRoll = message.rolls?.[0];
            attackRoll?.options?.isAttack && (applyAttackStateToRoll(message, attackRoll), ensureAttackTargetOnRoll(message, attackRoll));
            let roll = htmlElement.querySelector(".fbl-chat-roll");
            roll && roll.addEventListener("click", ev => {
                if (ev.target.closest(".fbl-button")) return;
                let details = roll.querySelector(".fbl-roll-details");
                details && (details.hidden = !details.hidden)
            });
            let postedItem = htmlElement.querySelector(".chat-item");
            postedItem && (postedItem.classList.add("draggable"), postedItem.setAttribute("draggable", "true"), postedItem.addEventListener("dragstart", ev => {
                let itemData = message.getFlag("forbidden-lands", "itemData");
                ev.dataTransfer.setData("text/plain", JSON.stringify({
                    item: itemData,
                    type: "itemDrop"
                }))
            }));
            let pushButton = htmlElement.querySelector(".fbl-button.push");
            pushButton && pushButton.addEventListener("click", async ev => {
                if (ev.stopPropagation(), message.rolls[0]?.pushable) {
                    let pushedRoll = (await FBLRollHandler.pushRoll(message))?.rolls?.[0];
                    pushedRoll?.options?.linkedAttackMessageId && await syncLinkedAttackFromDefenseRoll(pushedRoll);
                    let fireEvent = () => {
                        message.permission === CONST.DOCUMENT_OWNERSHIP_LEVELS.OWNER ? message.delete() : game.socket.emit("system.forbidden-lands", {
                            operation: "pushRoll",
                            isOwner: message.roll?.isOwner,
                            id: message.id
                        })
                    };
                    game.modules.get("dice-so-nice")?.active ? Hooks.once("diceSoNiceRollComplete", fireEvent) : fireEvent()
                }
            });
            let tableButton = htmlElement.querySelector(".fbl-button.table");
            tableButton && tableButton.addEventListener("click", async ev => {
                ev.stopPropagation();
                let table;
            ...
            let attackButtons = htmlElement.querySelectorAll(".fbl-button.attack-action");
            if (attackButtons.length) {
                if (!canCurrentUserUseAttackActions(message, attackRoll)) {
                    attackButtons.forEach(button => button.remove());
                    return
                }
                attackButtons.forEach(button => button.addEventListener("click", async ev => {
                    ev.stopPropagation();
                    try {
                        let roll2 = message.rolls?.[0];
                        if (!roll2?.options?.isAttack) return;
                        applyAttackStateToRoll(message, roll2), await ensureAttackTargetOnRoll(message, roll2);
                        let action = button.dataset.action,
                            targetActor = getAttackTarget(message, roll2);
                        if (!targetActor) {
                        ...
                        switch (action) {
                            case "apply-damage":
                                if (roll2.options.attackApplied || Number(roll2.attackSuccess || 0) <= 0) return;
                                await applyDamageToTarget(targetActor, roll2), await applyAttackArmorDamage(targetActor, roll2), roll2.options.attackApplied = !0;
                                break;
                            case "defense-dodge": {
                                if (roll2.options.defenseUsed) return;
                                let result = await rollTargetDefense(targetActor, "dodge", message.id);
                                if (!result?.roll) return;
                                roll2.options.defenseUsed = !0, roll2.options.defenseType = "dodge", roll2.options.defenseSuccess = Number(result.roll.successCount || 0);
                                break
                            }
                            case "defense-parry": {
                                if (roll2.options.defenseUsed) return;
                                if (isRangedAttack(roll2) && !hasEquippedShield(targetActor)) {
                                    await postRollWarning("ROLL.WARNING_PARRY_NO_SHIELD_RANGED");
                                    return
                                }
                                let parryItem = getParryItem(targetActor);
                                if (!parryItem) {
                                    await postRollWarning("ROLL.WARNING_PARRY_NO_WEAPON");
                                    return
                                }
                                let result = await rollTargetDefense(targetActor, "parry", message.id, parryItem.id);
                                if (!result?.roll) return;
                                roll2.options.defenseUsed = !0, roll2.options.defenseType = "parry", roll2.options.defenseSuccess = Number(result.roll.successCount || 0);
                                break
                            }
                            case "defense-resist": {
                                if (roll2.options.resistUsed) return;
                                let result = await rollTargetResist(targetActor, message.id);
                                if (!result?.roll) return;
                                roll2.options.resistUsed = !0, roll2.options.resistSuccess = Number(result.roll.successCount || 0);
                                break
                            }
                            case "defense-armor": {
                                if (roll2.options.armorUsed) return;
                                let armorResult = await rollTargetArmor(targetActor, message.id);
                                if (!armorResult?.roll) return;
                                let armorSuccess = Number(armorResult.roll.successCount || 0),
                                    armorFailure = Number(armorResult.roll.gearDamage || armorResult.roll.baneCount || 0);
                                roll2.options.armorUsed = !0, roll2.options.armorSuccess = armorSuccess, roll2.options.armorFailure = armorFailure;
                                break
                            }
                            default:
                                return
                        }
                        await persistAttackMessageState(message, roll2)
                    } catch {
        ...
        }), Hooks.on("hotbarDrop", async (_2, data, slot) => handleHotbarDrop(data, slot)), Hooks.on("activateAbstractSidebarTab", app => {
            if (app.id !== "settings") return;
            let section = $(app.element).find("section.documentation h4"),
            ...
            let header = app.element.querySelector(".header-actions");
            if (!header || header.querySelector("#create-adventure-site")) return;
            let button = document.createElement("button");
            button.id = "create-adventure-site", button.innerHTML = `<i class="fas fa-castle"></i> ${localizeString("ADVENTURE_SITE.BUTTON.CREATE")}`, button.addEventListener("click", () => adventureSiteCreateDialog()), header.appendChild(button)
        }), Hooks.on("renderJournalEntrySheet", (app, html, doc) => {
            let type = doc.document.getFlag("forbidden-lands", "adventureSiteType");
            if (!["dungeon", "ice_cave", "elven_ruin"].includes(type) || !game.user.isGM) return;
        ...
        tokens: scene.tokens.map(token => {
            ...
            if (!t.actorId || t.actorLink) t.actorData = {};
                ...
                for (let embeddedName of ["items", "effects"]) {
                    ...
                    let updates = new Map(update[embeddedName].map(u => [u._id, u]));
    ...
    Hooks.on("renderSettingsConfig", (_app, html, _user) => {
        let target = html.querySelector('input[name="forbidden-lands.datasetDir"]');
        if (!target) return;
        let targetParent = target.previousElementSibling,
            resetButton = document.createElement("button");
        resetButton.type = "button", resetButton.classList.add("file-picker"), resetButton.dataset.tooltip = localizeString("FLCG.SETTINGS.RESET"), resetButton.innerHTML = '<i class="fas fa-undo"></i>', resetButton.addEventListener("click", () => {
            target.value = "", resetButton.blur()
        });
        let experimentalButton = document.createElement("button");
        experimentalButton.type = "button", experimentalButton.classList.add("file-picker"), experimentalButton.dataset.tooltip = localizeString("FLCG.SETTINGS.RFP_SET"), experimentalButton.innerHTML = '<i class="fas fa-flask"></i>', experimentalButton.addEventListener("click", () => {
            target.value = "systems/forbidden-lands/assets/datasets/chargen/dataset-experimental.json", experimentalButton.blur()
    ...
    var TableConfigMenu = class extends FormApplication {
            ...
            async getData() {
                ...
                let folders = game.folders.filter(f3 => f3.type === "RollTable").sort((a, b3) => a.name.localeCompare(b3.name)),
                    tables = game.tables.contents.slice().sort((a, b3) => a.name.localeCompare(b3.name)),
                    flatOptions = [];
                for (let folder of folders) {
                    let folderTables = tables.filter(t => t.folder?.id === folder.id);
                    for (let table of folderTables) flatOptions.push({
                        label: table.name,
                        value: table.id,
                        group: folder.name
                    })
                }
                let unsorted = tables.filter(t => !t.folder);
                for (let table of unsorted) flatOptions.push({
                    label: table.name,
                    value: table.id,
                    group: game.i18n.localize("FOLDER.None")
                });
                return data.tables = flatOptions, data
            }
    ...
    function registerSettings() {
        ...
        }), Number(game.version?.slice(0, 2)) < 12 && game.settings.register("forbidden-lands", "darkmode", {
    ...
    var {
    ...
    } = foundry.applications.api, ActorSheetConfig = class _ActorSheetConfig extends HandlebarsApplicationMixin(ApplicationV2) {
        constructor(options = {}) {
            super(options), this.document = options.document;
            let actorName = this.document.name,
                configTitle = game.i18n.localize("CONFIG.ACTOR_SHEET_CONFIG.TITLE") || "Sheet Configuration";
        ...
        static DEFAULT_OPTIONS = {
            ...
            form: {
                handler: _ActorSheetConfig.myFormHandler,
                submitOnChange: !1,
                closeOnSubmit: !0
            },
            window: {
        ...
        async _prepareContext(options) {
            let documentName = this.document.documentName,
                allSheetClasses = CONFIG[documentName]?.sheetClasses || {},
                actorType = this.document.type || "character",
                relevantSheetClasses = allSheetClasses[actorType] || {};
            return {
    ...
    init_define_GLOBALPATHS();
    var ForbiddenLandsActorSheet = class extends foundry.appv1.sheets.ActorSheet {
        ...
        async getData() {
            ...
            if (data.system?.consumable)
                for (let [key, consumable] of Object.entries(data.system.consumable)) consumable.options = dieOptions;
            return data
        }
        get actorData() {
        ...
        computeEncumbrance(data) {
            ...
            if (this.actor.type === "character") {
                for (let consumable of Object.values(data.system.consumable)) consumable.value > 0 && (weightCarried += 1);
                ...
                weightCarried += Math.floor(coinsCarried / 100) * .5
            }
        ...
        getDamageTypeOptions(itemId = void 0, actionName = void 0) {
            let defaults = [{
                value: "non-typical",
                label: "ATTACK.NON_TYPICAL"
            }];
            if (!itemId) return actionName === "unarmed" ? [{
                value: "blunt",
                label: "ATTACK.BLUNT"
            }] : defaults;
            ...
            let features = item.system.features || {},
                options = [];
            return features.pointed && options.push({
                value: "stab",
                label: "ATTACK.STAB"
            }), features.edged && options.push({
                value: "slash",
                label: "ATTACK.SLASH"
            }), features.blunt && options.push({
                value: "blunt",
                label: "ATTACK.BLUNT"
            }), options.length ? options : defaults
        }
        rollAction(actionName, itemId = void 0) {
            ...
            if (actionName === "unarmed" && (options.damage = 1), options.damage || data.gear?.damage) {
                let damageTypeOptions = this.getDamageTypeOptions(itemId, actionName);
                options.damageTypeOptions = damageTypeOptions, options.damageType = damageTypeOptions[0]?.value || "non-typical"
            }
        ...
        rollGear(itemId) {
            ...
            if (data.gear?.damage) {
                let damageTypeOptions = this.getDamageTypeOptions(itemId);
                options.damageTypeOptions = damageTypeOptions, options.damageType = damageTypeOptions[0]?.value || "non-typical"
            }
            return FBLRollHandler.createRoll(data, {
                ...options,
        ...
        computeSkills(data) {
            let map = CONFIG.fbl.skillAttributeMap;
            for (let [key, skill] of Object.entries(data.system.skill)) {
                let connectedAttribute = map[key];
                skill[`has${connectedAttribute.capitalize()}`] = !0
            }
            return data
        }
        computeItems(data) {
        ...
        computeItemEncumbrance(data) {
            ...
            return data.flags?.state ? type === "rawMaterial" ? 1 * Number(data.system.quantity) : ["gear", "armor", "weapon"].includes(type) ? weight : 0 : 0
        }
        async #enrichTextEditorFields(data, isOwner) {
            let fields = CONFIG.fbl.enrichedActorFields;
            for (let field of fields) data.system.bio?.[field]?.value && (data.system.bio[field].value = await foundry.applications.ux.TextEditor.implementation.enrichHTML(data.system.bio[field].value, {
                async: !0,
                secrets: isOwner
            }));
            return data
    ...
    var ForbiddenLandsCharacterSheet = class extends ForbiddenLandsActorSheet {
        static get defaultOptions() {
        ...
        activateListeners(html) {
            super.activateListeners(html), html.find(".condition").click(async ev => {
            ...
            }), html.find(".roll-armor.total").click(() => this.rollArmor()), html.find(".roll-consumable").click(ev => {
                let consumable = $(ev.currentTarget).data("consumable");
                return this.rollConsumable(consumable)
            }), html.find(".roll-reputation").click(() => this.rollReputation()), html.find(".roll-pride").click(() => this.rollPride()), html.find(".currency-button").on("click contextmenu", ev => {
                let currency = $(ev.currentTarget).data("currency"),
                    operator = $(ev.currentTarget).data("operator"),
                    modifier = ev.type === "contextmenu" ? 5 : 1,
                    coins = [this.actor.actorProperties.currency.gold.value, this.actor.actorProperties.currency.silver.value, this.actor.actorProperties.currency.copper.value],
                    i = {
                        gold: 0,
                        silver: 1,
                        copper: 2
        ...
        async rollConsumable(identifier) {
            ...
            if (!consumable.value) return ui.notifications.warn("WARNING.NO_CONSUMABLE", {
                localize: !0
            });
            let rollName = localizeString(consumable.label),
                ...
                roll = FBLRoll.create(`${dice}[${rollName}]`, {}, options);
            await roll.roll();
            let message = await roll.toMessage();
            Number(message.rolls[0].result) <= (game.settings.get("forbidden-lands", "autoDecreaseConsumable") || 0) && FBLRollHandler.decreaseConsumable(message.id)
        }
        async rollPride() {
            if (!this.actor.canAct) throw this.broken();
            ...
            return await roll.roll(), roll.toMessage()
        }
        ...
        _onConfigureSheet(event) {
            event.preventDefault(), new ActorSheetConfig({
                document: this.actor,
                position: {
        ...
        _getHeaderButtons() {
            ...
            return this.actor.isOwner && (buttons = [{
                ...
                icon: "fas fa-leaf",
                onclick: async () => {
                    Object.values(this.actor.actorProperties.attribute).flatMap(a => a.value + a.max).some(v => v > 0) ? Dialog.confirm({
                        title: game.i18n.localize("FLCG.TITLE"),
                        content: `
    ...
    var ForbiddenLandsMonsterSheet = class extends ForbiddenLandsActorSheet {
        ...
        async getData() {
            let actorData = await super.getData();
            return this.computeSkills(actorData), this.computeItems(actorData), this.computeEncumbrance(actorData), actorData.monsterTypeOptions = [{
                value: "monster",
                label: "MONSTER.TYPE.MONSTER"
            }, {
                value: "mount",
                label: "MONSTER.TYPE.MOUNT"
            }], actorData
        }
        activateListeners(html) {
        ...
        async rollArmor() {
            ...
            return await roll.roll(), roll.toMessage(), !0
        }
        _getHeaderButtons() {
            let buttons = super._getHeaderButtons();
            return this.actor.isOwner && (buttons = [{
    ...
    var ForbiddenLandsStrongholdSheet = class extends ForbiddenLandsActorSheet {
        ...
        async getData() {
            let actorData = await super.getData();
            return actorData.system.description = await foundry.applications.ux.TextEditor.implementation.enrichHTML(actorData.system.description, {
                async: !0
            }), this._computeItems(actorData), actorData
        }
        _computeItems(data) {
            for (let item of Object.values(data.items)) item.isWeapon = item.type === "weapon", item.isArmor = item.type === "armor", item.isGear = item.type === "gear", item.isRawMaterial = item.type === "rawMaterial", item.isBuilding = item.type === "building", item.isHireling = item.type === "hireling", (item.type !== "building" || item.type !== "hireling") && (item.totalWeight = (CONFIG.fbl.encumbrance[item.system.weight] ?? item.system.weight ?? 1) * (item.system.quantity ?? 1))
        }
        activateListeners(html) {
            super.activateListeners(html), html.find("details").on("click", e => {
    ...
    init_define_GLOBALPATHS();
    var noop = () => {},
        CharacterPickerDialog = class _CharacterPickerDialog extends Application {
            constructor(actors, title, callback, onCancel = noop) {
                super(), this.actors = actors, this.titleText = title, this.callback = callback, this.onCancel = onCancel
            }
            static async show(title, characters, onSelect = noop, onCancel = noop) {
                let actors = characters.map(c => c instanceof Actor ? c : game.actors.get(c));
                new _CharacterPickerDialog(actors, title, onSelect, onCancel).render(!0)
            }
            static get defaultOptions() {
            ...
            activateListeners(html) {
                ...
                for (let el of html[0].querySelectorAll(".select-actor")) el.addEventListener("click", async event => {
                    event.preventDefault(), event.stopPropagation();
                    let uuid = el.dataset.uuid,
                        actor = await fromUuid(uuid);
                    this.callback(actor), this.close()
                })
            }
            close(options) {
                return this.onCancel?.(), super.close(options)
            }
        };
    init_define_GLOBALPATHS();
    init_define_GLOBALPATHS();
    ...
    function rollTravelAction(character, rollName) {
        !character || !character.isOwner || (rollName === "rest" ? character.rest() : character.sheet.rollAction(rollName))
    }
    ...
    function handleTravelAction(assignedPartyMemberIds, rollName) {
        ...
        assignedPartyMembers.length === 1 ? rollTravelAction(assignedPartyMembers[0], rollName) : assignedPartyMembers.length > 1 && CharacterPickerDialog.show(`${localizeString("FLPS.UI.WHO_ROLLS")} ${localizeString(rollName)}`, assignedPartyMembers, actor => {
    ...
    var ForbiddenLandsPartySheet = class extends foundry.appv1.sheets.ActorSheet {
        static get defaultOptions() {
        ...
        async getData() {
            ...
            return data.system.description = await foundry.applications.ux.TextEditor.implementation.enrichHTML(data.system.description, {
                async: !0
            }), data
        }
        activateListeners(html) {
        ...
        getTravelActions() {
            let travelActions = TravelActionsConfig,
                journal = game.journal.getName("Journey Reference");
            for (let action of Object.values(travelActions)) journal && (action.journalLink = journal.pages.getName(action.journalEntryName)?.uuid), action.participants = this.document.system.travel[action.key].map(id => game.actors.get(id));
    ...
    init_define_GLOBALPATHS();
    init_define_GLOBALPATHS();
    var ForbiddenLandsItemSheet = class _ForbiddenLandsItemSheet extends foundry.appv1.sheets.ItemSheet {
        get itemData() {
        ...
        async getData() {
            ...
            return data.editable = this.isEditable, data.flags = this.item.flags["forbidden-lands"], data.encumbranceValues = this.config.encumbrance, data.isGM = game.user.isGM, data = this.#computeQuality(data), data = await this.#enrichTextEditorFields(data), data.artifactBonusOptions = [{
                value: "",
                label: "ARTIFACT.REGULAR"
            }, {
                value: "0",
                label: "ARTIFACT.DICELESS"
            }, {
                value: "d8",
                label: "ARTIFACT.MIGHTY"
            }, {
                value: "d10",
                label: "ARTIFACT.EPIC"
            }, {
                value: "d12",
                label: "ARTIFACT.LEGENDARY"
            }], data
        }
    ...
    var ForbiddenLandsWeaponSheet = class extends ForbiddenLandsItemSheet {
        ...
        async getData(options = {}) {
            ...
            return data.weightOptions = [{
                ...
                value: "other",
                label: "WEAPON.AMMO_OTHER"
            }, {
                value: "arrows",
                label: "WEAPON.AMMO_ARROWS"
            }], data
        }
    };
    init_define_GLOBALPATHS();
    var ForbiddenLandsArmorSheet = class extends ForbiddenLandsItemSheet {
        ...
        async getData(options = {}) {
            ...
            return data.weightOptions = [{
                ...
                value: "other",
                label: "ARMOR.OTHER"
            }], data.system.enrichedFeatures = await foundry.applications.ux.TextEditor.enrichHTML(data.system.features ?? "", {
                async: !0,
    ...
    var ForbiddenLandsGearSheet = class extends ForbiddenLandsItemSheet {
        ...
        async getData(options) {
            let data = await super.getData(options);
            return data.encumbranceValues = CONFIG.fbl.encumbrance, data
        }
    };
    init_define_GLOBALPATHS();
    ...
    var ForbiddenLandsSpellSheet = class extends ForbiddenLandsItemSheet {
        ...
        async getData(options = {}) {
            let data = await super.getData(options);
            return data.spellTypes = [{
                value: "SPELL.SPELL",
                label: "SPELL.SPELL"
            }, {
                value: "SPELL.POWER_WORD",
                label: "SPELL.POWER_WORD"
            }, {
                value: "SPELL.EPIC",
                label: "SPELL.EPIC"
            }, {
    ...
    var ForbiddenLandsTalentSheet = class extends ForbiddenLandsItemSheet {
        ...
        async getData(options = {}) {
            let data = await super.getData(options);
            return data.talentTypes = [{
                value: "general",
                label: "TALENT.GENERAL"
            }, {
                value: "kin",
                label: "TALENT.KIN"
            }, {
                ...
                value: "monster",
                label: "TALENT.MONSTER"
            }, {
                value: "weakness",
                label: "TALENT.WEAKNESS"
            }], data
        }
    };
    init_define_GLOBALPATHS();
    ...
    var ForbiddenLandsMonsterAttackSheet = class extends ForbiddenLandsItemSheet {
        ...
        async getData(options = {}) {
            ...
            return data.rangeOptions = [{
                ...
                value: "empathy",
                label: "ATTACK.EMPATHY"
            }, {
                value: "endurance",
                label: "ATTACK.ENDURANCE"
            }, {
                value: "fear",
                label: "ATTACK.FEAR"
            }, {
    ...
    function registerSheets() {
        foundry.documents.collections.Actors.unregisterSheet("core", foundry.appv1.sheets.ActorSheet), foundry.documents.collections.Actors.registerSheet("forbidden-lands", ForbiddenLandsCharacterSheet, {
            types: ["character"],
            makeDefault: !0
            ...
            types: ["party"],
            makeDefault: !0
        }), foundry.documents.collections.Items.unregisterSheet("core", foundry.appv1.sheets.ItemSheet), foundry.documents.collections.Items.registerSheet("forbidden-lands", ForbiddenLandsWeaponSheet, {
            types: ["weapon"],
            makeDefault: !0
    ...
    init_define_GLOBALPATHS();
    var ForbiddenLandsTokenHUD = class extends foundry.applications.hud.TokenHUD {
    ...
    Hooks.once("init", () => {
        ...
        }, CONFIG.Actor.documentClass = ForbiddenLandsActor, CONFIG.Item.documentClass = ForbiddenLandsItem, CONFIG.statusEffects = [...CONFIG.statusEffects.filter(effect => !["sleep", "frozen", "curse"].includes(effect.id)), ...config_default.statusEffects], CONFIG.fbl = config_default, CONFIG.fbl.adventureSites.utilities = utilities, CONFIG.fbl.adventureSites.generate = (path, adventureSite) => init(path, adventureSite), YearZeroRollManager.register("fbl", {
        ...
        }), CONFIG.Dice.terms[6] = ForbiddenLandsD6, registerYZURLabels(), registerSheets(), initializeHandlebars(), initializeEditorEnrichers(), registerFonts(), modifyConfig(), game.settings.get("forbidden-lands", "removeBorders") && $("html").addClass("no-borders"), Number(game.version) < 12 && game.settings.get("forbidden-lands", "darkmode") && $("body").addClass("theme-dark")
    });
    Hooks.once("ready", () => {
    ...
    Hooks.on("canvasReady", canvas2 => {
        canvas2.hud.token = new ForbiddenLandsTokenHUD
    });
})();
